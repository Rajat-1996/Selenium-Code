...
public class CITBank_CDCalculator_DataDrivenTesting {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		String path="C:\\Users\\g529776\\.eclipse\\SeleniumWebDriverMavenProject\\TestData\\caldata2.xlsx";   // giving path to file to start reading
		...
		{			
			...
			WebElement compoundrp = driver.findElement(By.xpath("//mat-select[@id='mat-select-0']"));   //select class object compound drop will find elelment by id
			compoundrp.click();
			...
			calbutton.click();   ///click on button to calculate cd calculation based on Excel cell data
