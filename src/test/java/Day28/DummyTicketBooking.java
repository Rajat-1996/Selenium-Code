package Day28;
	...
	public class DummyTicketBooking {
		...
		public static void main(String[] args) throws InterruptedException {
			...
			driver.findElement(By.name("fromcity")).sendKeys("Mumbai"); //From city / Origin
			...
			selectDate(driver, depDateDatePicker, "29","Feb","2024"); //Departure date  DD/MM/YYYY
			
			//WebElement returnDateDatePicker=driver.findElement(By.xpath("//input[@id='returndate']"));
			//selectDate(driver, returnDateDatePicker, "16","Nov","2024"); //return date  DD/MM/YYYY
